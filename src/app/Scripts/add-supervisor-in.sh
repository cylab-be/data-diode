...
sed -i -e "s/#addhere/command=sudo python \/var\/www\/data-diode\/BlindFTP_0.37\/bftp.py -s \/var\/www\/data-diode\/src\/storage\/app\/files\/$1 -a 192.168.101.2 -b -P 5 -p $2 -u $1 -x\n#addhere/g" /etc/supervisord.conf
