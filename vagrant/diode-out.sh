...
echo "www-data ALL=NOPASSWD: /usr/bin/python, /usr/bin/python3, /var/www/data-diode/src/app/Scripts/datadiode.sh, /usr/local/bin/supervisord" | EDITOR="tee -a" visudo
