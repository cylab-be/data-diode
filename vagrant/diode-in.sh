...
echo "www-data ALL=NOPASSWD: /bin/rm, /usr/bin/python, /var/www/data-diode/src/app/Scripts/datadiode.sh, /var/www/data-diode/src/app/Scripts/sendpip.sh, /var/www/data-diode/uploadersScripts/db_uploaders_clie.py, /usr/local/bin/supervisord" | EDITOR="tee -a" visudo
